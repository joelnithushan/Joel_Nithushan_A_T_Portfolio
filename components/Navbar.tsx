...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 glass shadow-glass border-b dark:border-white/10 border-black/10"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="text-xl font-bold text-red-600 dark:text-white">
            Joel Nithushan
          </Link>
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-1">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="ml-2 p-2 rounded-lg glass hover:bg-white/5 transition-colors"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden border-t dark:border-white/10 border-black/10"
            >
